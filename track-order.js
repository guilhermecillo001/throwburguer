document.addEventListener('DOMContentLoaded', () => {
    ...
    const stages = [
        { duration: 1 * 60 * 10, message: 'Preparando pedido...', width: 0 }, // 15 minutos
        { duration: 1 * 60 * 30, message: 'Embalando pedido...', width: 50 }, // 5 minutos
        { duration: 1 * 60 * 50, message: 'Pedido em rota de entrega...', width: 100 } // 35 minutos
    ];
